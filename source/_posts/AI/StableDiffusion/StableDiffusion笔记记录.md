...
![image-20240313213624093](images/1.StableDiffusion入门.png)
...
![image-20240313221035400](images/2.StableDiffusion入门.png)
...
![image-20240318205840741](images/3.StableDiffusion入门.png)

**注意事项：如果使用的是默认预设，需要注意的是每次生成图片的参数不能超过模型规定的最大值和最小值之间，并且数值需要是64的倍数**
现在就可以看到出图的时间是非常的快了

![image-20240318210139874](images/4.StableDiffusion入门.png)

#### 预设参数

相同的参数设定下静态的预设比动态的预设性能更高显存占用更低

![image-20240318212229709](images/5.StableDiffusion入门.png)
...
![image-20240318212616607](images/6.StableDiffusion入门.png)
...
![image-20240322111448369](images/7.StableDiffusion入门.png)
...
![image-20240313214625819](images/8.StableDiffusion入门.png)
...
![](images/9.StableDiffusion入门.png)
...
![](images/10.StableDiffusion入门.png)
...
![image-20240313222409523](images/11.StableDiffusion入门.png)
...
![image-20240314211634069](images/12.StableDiffusion入门.png)
...
![image-20240314213810568](images/13.StableDiffusion入门.png)
...
![image-20240314214555324](images/14.StableDiffusion入门.png)

![image-20240314214546171](images/15.StableDiffusion入门.png)
...
![image-20240316110710073](images/16.StableDiffusion入门.png)
...
![image-20240317110251842](images/17.StableDiffusion入门.png)
...
![image-20240317113239780](images/18.StableDiffusion入门.png)
...
![image-20240314215754826](images/19.StableDiffusion入门.png)
...
![image-20240314220924696](images/20.StableDiffusion入门.png)

身体每张训练100步，头部训练100步，根据图片来定义

![image-20240314221258730](images/21.StableDiffusion入门.png)

然后将输出的地址粘贴到输出栏中

![image-20240314221234992](images/22.StableDiffusion入门.png)

### 2. Bucket自动裁剪

宽高不需要指定（保持默认的宽高），让AI自动来适应，一般使用 **kohyass** 使用Bucket

![image-20240314221814199](images/23.StableDiffusion入门.png)
...
![image-20240314223349913](images/24.StableDiffusion入门.png)

## 8.6 kohya_ss

![image-20240314222632209](images/25.StableDiffusion入门.png)
...
![image-20240314222957017](images/26.StableDiffusion入门.png)
