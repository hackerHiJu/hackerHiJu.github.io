...
![|500](images/1.LightRoom基础入门.png)

### 1.1 色相、饱和度、明度

- 色相：颜色的相貌，颜色的名字
![|500](images/2.LightRoom基础入门.png)
...
![image.png|500x379](images/3.LightRoom基础入门.png)
...
![image.png](images/4.LightRoom基础入门.png)
...
![image.png](images/5.LightRoom基础入门.png)
...
![|500](images/6.LightRoom基础入门.png)

###### 2. 青转蓝
- 组合：蓝 + 绿
- 转换公式：主要目的是减去绿，那么增加绿色互补色洋红

![|500](images/7.LightRoom基础入门.png)
###### 3. 黄转绿
- 组合：红 + 绿
- 转换公式：减去红色，增加互补色青色

![|500](images/8.LightRoom基础入门.png)

###### 4. 黄转红
- 组合：红 + 绿
- 转换公式：减去绿色，增加互补色品红

![|500](images/9.LightRoom基础入门.png)

##### 5. 品红转蓝
- 组合：红 + 蓝
- 转换公式：减去红色，增加红色互补色青色

![|500](images/10.LightRoom基础入门.png)

##### 6. 青转黄
- 转换公式：先将青色转换为绿色（减去蓝色，增加蓝色互补色黄色），在将绿色转换为黄色（加上红色，减去红色的互补色青色）


![|500](images/11.LightRoom基础入门.png)

##### 7. 黄转青
- 转换公式：将黄色转化为绿色（减去红色，增加红色互补色青色），在将绿色转换为黄色（加上蓝色，减去蓝色的互补色黄色）


![|500](images/12.LightRoom基础入门.png)

##### 8. 品红转黄
- 转换公式：将品红转换红色（减去蓝色，增加蓝色互补色黄色），将红色转换为黄色（增加绿色，减去绿色互补色品红）

![|500](images/13.LightRoom基础入门.png)
...
![|500](images/14.LightRoom基础入门.png)

##### 2. 黄转蓝
- 组合：蓝 = 品红 + 青
- 转换公式：减去黄色，加上品红和青色

![|500](images/15.LightRoom基础入门.png)
##### 3. 青转红
- 转换公式：先减去青色，在加上品红和黄色

![|500](images/16.LightRoom基础入门.png)

##### 4. 品红转绿
- 转换公式：先减去品红，在加上青色和黄色

![|500](images/17.LightRoom基础入门.png)
## 2. LightRoom
...
![直方图|500](images/18.LightRoom基础入门.svg)
...
![](./images/19.LightRoom基础入门.png)

#### 2.2.2 绿通道

网上是增加绿色，往下是增加洋红

![](./images/20.LightRoom基础入门.png)

#### 2.2.3 蓝通道

往上是增加蓝色，往下是增加黄色

![](./images/21.LightRoom基础入门.png)

#### 2.2.4 点曲线

控制照片的明暗度，往上是增加白色，往下是增加黑色

![](./images/22.LightRoom基础入门.png)
### 2.3 HSL（混色器）
...
![](./images/24.LightRoom基础入门.png)

![](./images/25.LightRoom基础入门.png)
#### 2.5.2 减少杂色
