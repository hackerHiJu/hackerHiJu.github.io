...
![image-20241220180628419|1570x1046](images/1.NodeRed基础入门到实践.png)
...
![image-20241220181302178](images/2.NodeRed基础入门到实践.png)

填写表达式

![image-20241224112928351](images/3.NodeRed基础入门到实践.png)



当创建一个 **inject** 后进行触发，并且打印对应的数据日志到控制台

![image-20241220181334463](images/4.NodeRed基础入门到实践.png)

![image-20241220184510490](images/5.NodeRed基础入门到实践.png)

#### 3. complete

complete节点用于监听对应节点的完成，当一个节点完成后会触发执行

![image-20241224111057435](images/6.NodeRed基础入门到实践.png)

通过节点进行关联需要监听哪一个，监听多个时每一个都会执行一次

![image-20241224111126171](images/7.NodeRed基础入门到实践.png)

#### 4. catch

捕获节点执行异常时进行执行对应的流程

![image-20241224111639305](images/8.NodeRed基础入门到实践.png)

- 所有节点：当前流程页中所有节点执行失败了都会进行触发
- 在同一个分组：在当前分组中的节点抛出异常进行触发
- 指定节点：选中多个节点进行触发

![image-20241224112246259](images/9.NodeRed基础入门到实践.png)

#### 5. status

用于监听某个节点的状态值变更信息，例如：tcp的连接、mqtt客户端的连接等，都会输出对应的状态信息

![image-20241224175133998](images/10.NodeRed基础入门到实践.png)
...
![image-20241224175538380](images/11.NodeRed基础入门到实践.png)

![image-20241224175557598](images/12.NodeRed基础入门到实践.png)
...
![image-20241225161449372](images/13.NodeRed基础入门到实践.png)

![image-20241225161433700](images/14.NodeRed基础入门到实践.png)
...
![image-20241225163640846](images/15.NodeRed基础入门到实践.png)
...
![image-20241225164417913](images/16.NodeRed基础入门到实践.png)
...
![image-20241225165051238](images/17.NodeRed基础入门到实践.png)

![image-20241225165138666](images/18.NodeRed基础入门到实践.png)

#### 5. template

创建模板数据，根据 **mustache** 语法来指定转换为对应的格式

![image-20241225165434076](images/19.NodeRed基础入门到实践.png)

![image-20241225165539007](images/20.NodeRed基础入门到实践.png)
...
![image-20241225170605389](images/21.NodeRed基础入门到实践.png)
...
![image-20250117104803713](images/22.NodeRed基础入门到实践.png)

#### 2. mqtt out

输出数据到对应的topic中

![image-20250117104839224](images/23.NodeRed基础入门到实践.png)

#### 3. http in

创建一个http的请求接口，请求的路径是 服务部署的路径+端口/hello，例如：127.0.0.1:1880/echo

![image-20250117105414263](images/24.NodeRed基础入门到实践.png)

#### 4. http response

创建一个响应返回给 http in作为响应对象

![image-20250117105614886](images/25.NodeRed基础入门到实践.png)

![image-20250117111239544](images/26.NodeRed基础入门到实践.png)
...
![image-20250117111438516](images/27.NodeRed基础入门到实践.png)

![image-20250117111425808](images/28.NodeRed基础入门到实践.png)
...
![image-20250117141311846](images/29.NodeRed基础入门到实践.png)

![image-20250117141251735](images/30.NodeRed基础入门到实践.png)
