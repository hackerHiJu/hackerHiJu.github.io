...
tags:
  - TOOLS
cover: /images/covers/Tools.jpg
thumbnail: /images/covers/Tools.jpg
published: true
abbrlink: 1143619639
...
![](images/1.GitHub+Typora+PicGo实现图片自动上传入门.png)

![image-20230329155043676](images/2.GitHub+Typora+PicGo实现图片自动上传入门.png)

![image-20230801140804692](images/3.GitHub+Typora+PicGo实现图片自动上传入门.png)
...
![image-20230329155905763](images/4.GitHub+Typora+PicGo实现图片自动上传入门.png)
...
![image-20230329160414727](images/5.GitHub+Typora+PicGo实现图片自动上传入门.png)

## 3.2 PicGo（command）

直接下载即可，保存的路径是 **C:\Users\用户\AppData\Roaming\Typora\picgo\win64** 下载的是 **picgo.exe** 文件

![image-20230329162144750](images/6.GitHub+Typora+PicGo实现图片自动上传入门.png)
...
![image-20230329162546328](images/7.GitHub+Typora+PicGo实现图片自动上传入门.png)