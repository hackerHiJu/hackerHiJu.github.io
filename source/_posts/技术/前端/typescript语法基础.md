...
tags:
  - TS
  - 前端
cover: /images/covers/Frontend.jpg
thumbnail: /images/covers/Frontend.jpg
published: true
abbrlink: 3599161440
---
...
![image-20230728174749432](images/1.Typescript基础入门.png)

注意只读属性，如果有默认值，一定要指定明确的类型，否则会变成字面量类型

![image-20230728175156775](images/2.Typescript基础入门.png)
...
![image-20230728175836258](images/3.Typescript基础入门.png)

成员多的也可以兼容成员少的

![image-20230728181141381](images/4.Typescript基础入门.png)

#### 接口兼容

![image-20230728181553384](images/5.Typescript基础入门.png)

#### class与接口兼容

![](images/6.Typescript基础入门.png)
...
![image-20230803154319259](images/7.Typescript基础入门.png)

- 返回值类型：如果返回值是原始类型相同，只需要关注返回值本身即可

![image-20230803154736952](images/8.Typescript基础入门.png)

### 1.3 交叉类型

交叉类型跟继承很像，直接使用 **&** 即可，然后使用一个类型别名赋值给一个新的类型

![image-20230803155025469](images/9.Typescript基础入门.png)
...
- 不同点：对于同名属性之间，处理类型冲突的方式不同
  ...
  ![image-20230803155339634](images/10.Typescript基础入门.png)

  - 交叉类型，如果出现相同的类型，这是就可以理解为联合类型

  ![image-20230803155530226](images/11.Typescript基础入门.png)
...
![image-20230803160258915](images/12.Typescript基础入门.png)
...
![image-20230803161556432](images/13.Typescript基础入门.png)

泛型之间也可以进行约束，例如：t1需要传入一个泛型，key需要的类型是KEY，而KEY通过 **keyof TYPE** 获取到了 TYPE类型中的所有属性名称的联合类型；如果传递的是 **string** 类型，后面可以传递 **string** 中所具有的方法

![image-20230803164401520](images/14.Typescript基础入门.png)

#### 1.4.3 泛型接口

直接在接口上定义泛型的类型

![image-20230803165157307](images/15.Typescript基础入门.png)

#### 1.4.4 泛型类

泛型类跟泛型接口是一样的定义方式，在使用时最好明确的指示泛型的类型

![image-20230810142524852](images/16.Typescript基础入门.png)

![image-20230810142504341](images/17.Typescript基础入门.png)
...
![image-20230810143058074](images/18.Typescript基础入门.png)

![image-20230810143109186](images/19.Typescript基础入门.png)

#### 1.5.2 Readonly<Type\>

将所有的属性变为只读的类型，结构不会变

![image-20230810143321668](images/20.Typescript基础入门.png)
...
![image-20230810143636467](images/21.Typescript基础入门.png)

#### 1.5.4 Record<Keys,Type\>

构造一个对象类型，属性键为Keys，属性类型为Type，下面的例子：就新构建了类型 **RecordObj** 启动属性值就有 **Keys** 中指定的

![image-20230811170330887](images/22.Typescript基础入门.png)

![image-20230811170440068](images/23.Typescript基础入门.png)
...
![image-20230811171010416](images/24.Typescript基础入门.png)
...
![image-20230811171638783](images/25.Typescript基础入门.png)

也可以根据一个类中的所有key来作为一个新的类型

![image-20230814134447876](images/26.Typescript基础入门.png)

索引查询类型，通过 **P[Key]** 就可以获取到对应字段的类型

![image-20230814135244556](images/27.Typescript基础入门.png)
