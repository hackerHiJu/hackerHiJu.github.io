...
![image-20211021143108986](images/1.JVM（3）-垃圾回收.png)
...
![image-20211021145716271](images/2.JVM（3）-垃圾回收.png)

软引用也需要占用空间，所以也需要清楚掉，就需要引用队列

![image-20211021150030609](images/3.JVM（3）-垃圾回收.png)

弱引用

![image-20211021150523329](images/4.JVM（3）-垃圾回收.png)
...
![image-20211021150918195](images/5.JVM（3）-垃圾回收.png)
...
![image-20211021151203348](images/6.JVM（3）-垃圾回收.png)
...
![image-20211021151521740](images/7.JVM（3）-垃圾回收.png)

## 3. 垃圾分代（结合前面三种算法）

![image-20211021151626709](images/8.JVM（3）-垃圾回收.png)
...
![image-20211028102438721](images/9.JVM（3）-垃圾回收.png)
...
![image-20211028144136430](images/10.JVM（3）-垃圾回收.png)
...
![image-20211028145224683](images/11.JVM（3）-垃圾回收.png)
